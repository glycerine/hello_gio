...
func ImageMain() {
	go func() {
		...
		m.pngPlot, _, err = LoadImage("dax.png")
		panicOn(err)
...
// func showNumbersDemo(e app.UpdateEvent, m *myDrawState) {
// 	c := m.gtx
// 	c.Reset(&e.Config, layout.RigidConstraints(e.Size))
// 	m.faces.Reset(c.Config)
// 	var material op.MacroOp
//
// 	// record a macro of operations
// 	material.Record(c.Ops)
// 	paint.ColorOp{Color: m.maroon}.Add(c.Ops)
// 	material.Stop()
//
// 	text.Label{Material: material,
// 		Face:      m.face,
// 		Alignment: text.Middle,
// 		Text:      m.message}.Layout(c)
// 	m.w.Update(c.Ops)
// }
